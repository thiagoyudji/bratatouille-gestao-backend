...
public class OperationalCostsApiController implements OperationalCostsApi {

    private final OperationalCostsApiDelegate delegate;

    public OperationalCostsApiController(@Autowired(required = false) OperationalCostsApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new OperationalCostsApiDelegate() {});
    }

    @Override
    public OperationalCostsApiDelegate getDelegate() {
        return delegate;
    }
