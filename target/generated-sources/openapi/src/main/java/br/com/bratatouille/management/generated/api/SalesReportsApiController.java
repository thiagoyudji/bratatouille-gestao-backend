...
public class SalesReportsApiController implements SalesReportsApi {

    private final SalesReportsApiDelegate delegate;

    public SalesReportsApiController(@Autowired(required = false) SalesReportsApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new SalesReportsApiDelegate() {});
    }

    @Override
    public SalesReportsApiDelegate getDelegate() {
        return delegate;
    }
