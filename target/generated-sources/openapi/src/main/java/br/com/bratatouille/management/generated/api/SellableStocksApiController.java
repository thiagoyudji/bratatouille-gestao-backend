...
public class SellableStocksApiController implements SellableStocksApi {

    private final SellableStocksApiDelegate delegate;

    public SellableStocksApiController(@Autowired(required = false) SellableStocksApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new SellableStocksApiDelegate() {});
    }

    @Override
    public SellableStocksApiDelegate getDelegate() {
        return delegate;
    }
