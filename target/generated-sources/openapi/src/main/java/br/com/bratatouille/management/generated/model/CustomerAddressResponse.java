...
/**
 * Endereço persistido do customer.
 */

@Schema(name = "CustomerAddressResponse", description = "Endereço persistido do customer.")
...
public class CustomerAddressResponse {
  ...
  public CustomerAddressResponse label(@Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public CustomerAddressResponse zipCode(@Nullable String zipCode) {
  ...
  public CustomerAddressResponse street(@Nullable String street) {
    this.street = street;
    return this;
  }
  ...
  public CustomerAddressResponse number(@Nullable String number) {
    this.number = number;
    return this;
  }
  ...
  public CustomerAddressResponse neighborhood(@Nullable String neighborhood) {
  ...
  public CustomerAddressResponse state(@Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public CustomerAddressResponse city(@Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public CustomerAddressResponse complement(@Nullable String complement) {
  ...
  public CustomerAddressResponse defaultAddress(@Nullable Boolean defaultAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, customerAddressResponse.label) &&
        Objects.equals(this.zipCode, customerAddressResponse.zipCode) &&
        Objects.equals(this.street, customerAddressResponse.street) &&
        Objects.equals(this.number, customerAddressResponse.number) &&
        Objects.equals(this.neighborhood, customerAddressResponse.neighborhood) &&
        Objects.equals(this.state, customerAddressResponse.state) &&
        Objects.equals(this.city, customerAddressResponse.city) &&
        Objects.equals(this.complement, customerAddressResponse.complement) &&
        Objects.equals(this.defaultAddress, customerAddressResponse.defaultAddress);
  }
