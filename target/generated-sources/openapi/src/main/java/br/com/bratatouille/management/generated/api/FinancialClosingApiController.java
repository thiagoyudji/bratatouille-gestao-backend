...
public class FinancialClosingApiController implements FinancialClosingApi {

    private final FinancialClosingApiDelegate delegate;

    public FinancialClosingApiController(@Autowired(required = false) FinancialClosingApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new FinancialClosingApiDelegate() {});
    }

    @Override
    public FinancialClosingApiDelegate getDelegate() {
        return delegate;
    }
