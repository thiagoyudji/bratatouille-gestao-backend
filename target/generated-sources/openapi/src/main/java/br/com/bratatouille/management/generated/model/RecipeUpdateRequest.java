...
public class RecipeUpdateRequest {
   ...
   */
  public RecipeUpdateRequest(String name, Long outputItemId, List<@Valid RecipeItemRequest> items) {
    this.name = name;
    this.outputItemId = outputItemId;
    this.items = items;
  }

  public RecipeUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RecipeUpdateRequest outputItemId(Long outputItemId) {
    this.outputItemId = outputItemId;
    return this;
  }
  ...
  public RecipeUpdateRequest items(List<@Valid RecipeItemRequest> items) {
    this.items = items;
    return this;
  }

  public RecipeUpdateRequest addItemsItem(RecipeItemRequest itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    RecipeUpdateRequest recipeUpdateRequest = (RecipeUpdateRequest) o;
    return Objects.equals(this.name, recipeUpdateRequest.name) &&
        Objects.equals(this.outputItemId, recipeUpdateRequest.outputItemId) &&
        Objects.equals(this.items, recipeUpdateRequest.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipeUpdateRequest {\n");
